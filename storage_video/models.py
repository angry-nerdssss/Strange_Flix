...
class Like(models.Model):
    users=models.ManyToManyField(User,related_name='requirement_video_likes')
    video = models.OneToOneField(Video, related_name="likes", on_delete=models.CASCADE)
...
class Dislike(models.Model):
    users=models.ManyToManyField(User,related_name='requirement_video_dis_likes')
    video = models.OneToOneField(Video, related_name="dis_likes", on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    def __str__(self):
        return str(self.video.title)[:30]
